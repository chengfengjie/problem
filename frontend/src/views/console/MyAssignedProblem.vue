<template>
    <div>
        ...
        <el-table :row-style="handleRowStyle" @cell-click="handleCellClick" :data="tableData" border>
            ...
            <el-table-column label="处理人" prop="solveUserName" width="110px"></el-table-column>
        ...
        methods: {
            fetchData() {
                let data = {
                    ...
                    inUserID: this.$store.getters.userID,
